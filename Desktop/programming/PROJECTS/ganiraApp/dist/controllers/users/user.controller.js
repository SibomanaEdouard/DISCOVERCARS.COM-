...
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (eOtp) {
            return res
                .status(400)
                .json({ message: "Otp have been sent, verify to continue!" });
        }
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (((_a = user.verified) === null || _a === void 0 ? void 0 : _a.toString()) == "false") {
            return res.status(401).json({ message: "Verify account to continue..." });
        }
        return res.status(200).json({
...
const resendOtp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!(yield otpRepo.delete(eOtp))) {
            return res
                .status(500)
                .json({ message: "Error while deleting the otp..." });
        }
        const otp = (0, user_utils_1.generateOtp)();
