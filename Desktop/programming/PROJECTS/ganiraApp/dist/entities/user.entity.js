...
let User = class User {
    constructor(username, sector, password, nationalId, phoneNumber, village, cell, district, province, role, verified, imageUrl) {
        this.cell = cell;
...
User = __decorate([
    Entity("users"),
    __metadata("design:paramtypes", [String, String, String, String, String, String, String, String, String, String, Boolean, String])
], User);
